...
namespace GraphQLDemo
{
    ...
    {
        public static string DbConnectionString = "Server=(localdb)\\Projects; Database=MyHotelDb; Trusted_Connection=True;";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //ROOMS
            modelBuilder.Entity<Room>().HasData(new Room(101, "yellow-room", 1, false) { Id = 1 });
            modelBuilder.Entity<Room>().HasData(new Room(102, "blue-room", 1, false) { Id = 2 });
            modelBuilder.Entity<Room>().HasData(new Room(103, "white-room", 1, false) { Id = 3 });
            modelBuilder.Entity<Room>().HasData(new Room(104, "black-room", 1, false) { Id = 4 });
